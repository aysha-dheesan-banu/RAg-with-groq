...
from langchain_groq import ChatGroq  # ✅ Switched from ChatOpenAI

# Load environment variables
load_dotenv()
groq_api_key = os.environ["GROQ_API_KEY"]  # ✅ Using Groq key
...
def create_conversational_chain(vector_store):
    llm = ChatGroq(  # ✅ Changed from ChatOpenAI to ChatGroq
